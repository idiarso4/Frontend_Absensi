...
class LeaveScreen extends BaseScreen<LeaveNotifier> {
  ...
  @override
  Widget buildScreenContent(BuildContext context, LeaveNotifier notifier) {
    return RefreshIndicator(
      onRefresh: () => notifier.loadLeaveRequests(),
      child: _buildLeaveList(notifier),
    );
  }

  Widget _buildLeaveList(LeaveNotifier notifier) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return _buildLeaveCard(leave, context, notifier);
      },
    );
  }

  Widget _buildLeaveCard(LeaveRequest leave, BuildContext context, LeaveNotifier notifier) {
    Color statusColor;
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () => _showLeaveDetail(leave, context, notifier),
        borderRadius: BorderRadius.circular(12),
        child: Padding(
          padding: EdgeInsets.all(16),
          child: Column(
  ...
  void _showLeaveDetail(LeaveRequest leave, BuildContext context, LeaveNotifier notifier) {
    showModalBottomSheet(
      context: context,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.vertical(top: Radius.circular(20)),
